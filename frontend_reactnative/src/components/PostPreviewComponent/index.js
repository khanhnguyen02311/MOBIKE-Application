...
const PostPreviewComponent = ({form, onPost}) => {
      ...
      <Container
        ...
        <View style={{paddingHorizontal: 20, marginTop: 5}}>
          ...
          <View
            ...
            <Text
              style={{fontWeight: 'bold', color: colors.textRed, fontSize: 18}}>
        ...
        <View style={{paddingHorizontal: 20, marginTop: 15}}>
          ...
          <View style={{marginTop: 20}}>
            ...
            <View
              ...
              <View style={{width: widthScreen / 2 - 30}}>
                ...
                <View style={{flexDirection: 'row', marginBottom: 15}}>
                  ...
                  />
                  <Text
                    style={{marginLeft: 5, color: '#555', fontWeight: '400'}}>
                    Branch :{' '}
                  </Text>
                  <Text
                    style={{
                ...
                <View style={{flexDirection: 'row', marginBottom: 15}}>
                  ...
                  <Text
                    ...
                    {conditionNameFromID(form.condition)}
                  </Text>
                </View>
                ...
                <View style={{flexDirection: 'row', marginBottom: 15}}>
                  ...
                  />
                  <Text
                    style={{marginLeft: 8, color: '#555', fontWeight: '400'}}>
                    Cubic Power :{' '}
                  </Text>
                  <Text
                    style={{
                ...
                <View>
                  ...
                  <View style={{flexDirection: 'row', marginBottom: 15}}>
                    <FontAwesome
                      name="circle"
                      size={18}
                      color={colorHexFromID(form.color)}
                    />
                    <Text
                      style={{marginLeft: 8, color: '#555', fontWeight: '400'}}>
                      Color :{' '}
            ...
            {/* License Plate */}
            <View
              style={{flexDirection: 'row', marginBottom: 15, paddingLeft: 7}}>
          ...
          <View style={{marginHorizontal: 15, flex: 1}}>
            ...
            <View
              ...
              <Text
                ...
                10/34, Thong Nhat Ward, Bien Hoa City, Dong Nai Province
              </Text>
            </View>
          </View>
        </View>
