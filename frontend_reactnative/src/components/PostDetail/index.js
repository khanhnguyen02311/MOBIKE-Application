...
const PostDetailComponent = ({postID, isActivePost, isAdmin}) => {
          ...
          <View style={{width: widthScreen / 2 - 30}}>
            ...
            <View style={{flexDirection: 'row', marginBottom: 15}}>
              ...
              <Text
                ...
                {conditionNameFromID(postInfo.vehicleinfo.ID_Condition)}
              </Text>
            </View>
            ...
            <View style={{flexDirection: 'row', marginBottom: 15}}>
              ...
              <Text
                ...
                {postInfo.vehicleinfo.Cubic_power > 0
            ...
            <View style={{flexDirection: 'row', marginBottom: 15}}>
              ...
              <Text
                ...
                {postInfo.vehicleinfo.Vehicle_name}
              </Text>
            </View>
          </View>
          <View style={{width: widthScreen / 2 - 30}}>
            <View>
              ...
              <View style={{flexDirection: 'row', marginBottom: 15}}>
                ...
                <Text
                  ...
                  {lineupNameFromID(postInfo.vehicleinfo.ID_VehicleLineup)}
                </Text>
              </View>
              ...
              <View style={{flexDirection: 'row', marginBottom: 15}}>
                ...
                <FontAwesome
                  name="circle"
                  size={18}
                  color={colorHexFromID(postInfo.vehicleinfo.ID_Color)}
                  style={{marginLeft: 5}}
                />
                <Text
                  style={{
                  ...
                  {colorNameFromID(postInfo.vehicleinfo.ID_Color)}
                </Text>
              </View>
              ...
              <View style={{flexDirection: 'row', marginBottom: 15}}>
                ...
                <Text
                  ...
                  {postInfo.vehicleinfo.Odometer > 0
              ...
              <View style={{flexDirection: 'row', marginBottom: 15}}>
                ...
                <Text
                  ...
                  {postInfo.vehicleinfo.Manufacture_year > 0
            ...
            <Container
              ...
              <View>
                ...
                <View
                  ...
                  <MobikeImage.Avatar
                    ID={postInfo.user.ID_Image_Profile}
                    style={{
                      width: 48,
                      height: 48,
                      borderRadius: 500,
                  ...
                  <View style={{marginHorizontal: 15, flex: 1}}>
                    ...
                    <View
                      ...
                      <Text
                        ...
                        {wardNameFromID(postInfo.address.ID_Ward) +
                          ', ' +
                          districtNameFromID(postInfo.address.ID_District) +
                          ', ' +
                          cityNameFromID(postInfo.address.ID_City)}
                      </Text>
                    </View>
