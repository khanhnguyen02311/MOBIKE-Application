...
const ReviewDetailComponent = ({ postID, isActivePost, isAdmin }) => {
                ...
                <Animated.View
                    ...
                    {isLoading ? (
                        ...
                        <Container
                            ...
                            {/* Image */}
                            <View>
                                <Image source={require('../../assets/images/Honda.webp')} style={{
                                    width: widthScreen,
                                    height: widthScreen / 1.5,
                                    resizeMode: 'cover',
                                    marginBottom: 10,
                                }} />
                                <View style={{ backgroundColor: '#000', position: 'absolute', width: widthScreen, height: widthScreen / 1.5, opacity: 0.5, justifyContent: 'center', alignItems: 'center' }}>
                                    <View style={{ justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
                                        <AntDesign name="banckward" size={32} color="#fff" />
                                        <AntDesign name="caretright" size={32} color="#fff" style={{ marginHorizontal: 30 }} />
                            ...
                            <View style={{ paddingHorizontal: 20, marginTop: 5, marginBottom: 10, }}>
                                ...
                                <View
                                    ...
                                    <View
                                        ...
                                        <Text>
                                            <Text style={{ fontSize: 10, color: '#8D8D8D', fontWeight: 'bold' }}>Post : </Text>
                                            <Text style={{ fontSize: 12, color: colors.text, fontWeight: 'bold' }}>Honda CB200X</Text>
                                        </Text>
                        ...
                        View page >
                            ...
                            <View>
                                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 15, marginHorizontal: 15, }}>
                                    <Text style={{ fontSize: 17, color: "#000", fontWeight: 'bold' }}>Comment</Text>
                                    <Text style={{ fontSize: 12, color: colors.text, fontStyle: 'italic', fontWeight: '400' }}>See all > </Text>
                                </View>
                            </View>
                            ...
                            <View style={{ justifyContent: 'center', alignItems: 'center', borderRadius: 15, paddingHorizontal: 30, paddingVertical: 8, backgroundColor: colors.secondary, alignSelf: 'flex-end', marginRight: '5%', }}>
                                <Text style={{ color: colors.text, fontSize: 12, fontWeight: '600' }}>Send</Text>
                            </View>
