...
import { EDIT_ACCOUNT, EDIT_PTOFILE, MY_BIDS, MY_ORDERS } from '../../constants/routeNames';
...
const ProfileComponent = () => {
  ...
  return (
    <View style={{ height: '100%', alignItems: 'center' }}>
      ...
      <TouchableWithoutFeedback onPress={() => { navigate(MY_ORDERS) }}>
        <View
          style={{
            flexDirection: 'row',
            justifyContent: 'space-between',
          ...
          <Text style={{ color: '#000', fontSize: 18 }}>My Orders</Text>
          <Text style={{ color: '#000', fontSize: 18 }}>></Text>
        </View>
      </TouchableWithoutFeedback>
      ...
      <TouchableWithoutFeedback onPress={() => { navigate(MY_BIDS) }}>
        <View
          style={{
            flexDirection: 'row',
            justifyContent: 'space-between',
          ...
          <Text style={{ color: '#000', fontSize: 18 }}>My Bids</Text>
          <Text style={{ color: '#000', fontSize: 18 }}>></Text>
        </View>
      </TouchableWithoutFeedback>
