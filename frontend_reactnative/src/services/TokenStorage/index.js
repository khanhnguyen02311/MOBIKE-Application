...
export const signUp = async (
  ...
  const response = await HttpRequest.PostRequest('auth/signup', {
    username: username,
    email: email,
    phone: phone,
    password: password,
...
export const signIn = async (
  ...
  const response = await HttpRequest.PostRequest('auth/signin', {
...
export const print = async () => {
  try {
    let isTokenStorageInitialized = await AsyncStorage.getItem(
      'TokenStorageInitted',
    );
    if (isTokenStorageInitialized) {
